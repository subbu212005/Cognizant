    ...
    public class UserManagerTests
    {
        ...
        public void CreateUser_NullUser_ThrowsNullReferenceException()
        {
            Assert.That(() => manager.CreateUser(null),
                ...
                .With.Message.EqualTo("PAN Card Number is required."));
        }
        ...
        public void CreateUser_NullPAN_ThrowsNullReferenceException()
        {
            ...
            Assert.That(() => manager.CreateUser(user),
                Throws.TypeOf<NullReferenceException>()
                .With.Message.EqualTo("PAN Card Number is required."));
        }
        ...
        public void CreateUser_InvalidPANLength_ThrowsFormatException()
        {
            ...
            Assert.That(() => manager.CreateUser(user),
                ...
                .With.Message.EqualTo("PAN Card Number should contain exactly 10 characters."));
        }
    }
}
